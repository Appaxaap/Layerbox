          ...
          <div className="h-full min-h-0 relative">
            ...
            {!isMobile && (
              <>
                ...
                {showPanels && (
                  <div className="absolute left-3 top-3 bottom-3 w-[270px] flex flex-col gap-2 z-30 pointer-events-none">
                    <div
                ...
                {showPanels && (
                  <div
                    className="absolute right-3 top-3 bottom-3 w-[270px] z-30 animate-fade-up pointer-events-auto rounded-2xl overflow-hidden"
                    style={{
                      background: "var(--surface)",
                      border: "1px solid var(--border)",
                      filter: "drop-shadow(0 8px 32px rgba(0,0,0,0.35))",
                ...
                {showPanels && (
                  <div
                    className="absolute bottom-3 left-[300px] right-[300px] h-[360px] z-30 animate-fade-up rounded-2xl overflow-hidden pointer-events-auto"
                    style={{
